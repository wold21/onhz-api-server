...
import com.onhz.server.repository.GenreCatalogRepository;
...
public class CommonService {
    ...
    public List<GenreCatalogSimpleResponse> getGenreCatalogs() {
        Sort sort = Sort.by(Sort.Order.asc("id"));
        List<GenreCatalogSimpleResponse> results = GenreCatalogSimpleResponse.fromList(genreCatalogRepository.findAll(sort));
        return results;
    }

    public GenreCatalogResponse getGenreCatalog(String genreCode) {
        return GenreCatalogResponse.of(genreCatalogRepository.findByCode(genreCode)
